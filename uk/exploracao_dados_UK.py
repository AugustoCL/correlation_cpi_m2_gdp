...
fig.suptitle("Histograma das correlações móveis para M2, GDP, M2/GDP (Reino Unido)", y=.995, fontsize=16)
fig.tight_layout() 
...
fig.suptitle("Inflação Reino Unido x Emissão Monetária sobre PIB - Dados Trimestrais", fontsize=14)
